    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/router.DatabaseExport"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/router.DatabaseRestoreRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/file/{id}/decrement": {
            "patch": {
                ...
                "responses": {
                    "204": {
                        "description": "Reference count decremented successfully (and file deleted if count reached zero)"
                    },
                    "400": {
                        "description": "Bad Request",
                        "schema": {
        ...
        "router.DatabaseExport": {
            ...
            "properties": {
                ...
                "file_blobs": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.FileBlob"
                    }
                },
                "files": {
                    "type": "array",
